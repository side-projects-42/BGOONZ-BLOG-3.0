...
You can take a look at an **MVP** and play around with a **live demo** of all these parts working together [over on GitHub](https://github.com/bgoonz/dark-mode-minimal).
